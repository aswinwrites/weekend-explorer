  ...
  return (
    <div>
      <div className="flex items-center gap-2 mb-3">
        ...
        <h3 className="text-sm font-semibold text-stone-200">Share</h3>
      </div>
      <div className="flex items-center gap-2">
        ...
        <button
          onClick={copyLink}
          className="flex-1 flex items-center justify-center gap-1.5 py-2 rounded-xl bg-white/5 text-stone-400 text-xs font-medium transition-colors hover:bg-white/10 hover:text-white"
        >
