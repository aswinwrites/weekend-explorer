  ...
  theme: {
    extend: {
      colors: {
        ...
        earth: { 50: '#fdf8f0', 100: '#faefd8', 200: '#f4daa8', 300: '#ecbe6e', 400: '#e3993b', 500: '#d97c1b', 600: '#c16212', 700: '#9f4810', 800: '#823915', 900: '#6b2f14', 950: '#3d1507' },
      },
      animation: {
        'pulse-slow': 'pulse 3s cubic-bezier(0.4, 0, 0.6, 1) infinite',
        'fade-in': 'fadeIn 0.3s ease-in-out',
        'slide-up': 'slideUp 0.4s cubic-bezier(0.32, 0.72, 0, 1)',
        'slide-right': 'slideRight 0.4s cubic-bezier(0.32, 0.72, 0, 1)',
      },
      keyframes: {
